...
export const metadata: Metadata = {
  ...
  description: "A股 复盘工具 — 实时行情、个股诊断、智能盯盘",
  metadataBase: new URL("https://aikanpan.top"),
  openGraph: {
    title: "爱看盘 · 每日复盘工具",
    description: "爱看盘是一款开源 A 股与美股复盘工具，提供实时行情、市场温度、涨跌停池、个股诊断与批量评分、自然语言智能盯盘、美股研究台、持仓管理与交易流水，数据来自东方财富、新浪财经、Finnhub、EODHD 等公开接口。",
